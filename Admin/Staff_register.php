...
$texts = [
    'en' => [
        ...
        'form_title' => 'DBU Staff Registration Form',
        'id' => 'ID',
    ...
    'am' => [
        ...
        'form_title' => 'የደብረ ብርሃን ዩኒቨርሲቲ ሰራተኞች ማስመዝገቢያ ቅፅ',
        'id' => 'መለያ',
        'first_name' => 'ስም',
        'middle_name' => 'የአባት ስም',
        'last_name' => 'የአያት ስም',
        ...
        'qr_code' => 'QR ኮድ',
        'add_staff' => 'አዲስ ሰራተኛ ይጨምሩ',
        'language' => 'ቋንቋ',
        'rights' => 'ሁሉም መብቶች በቅጥ ይጠበቃሉ።',
        'college_placeholder' => 'ፈልግ ወይም ኮሌጅ/ዳይሬክቶሬት ይምረጡ',
    ]
];
$t = $texts[$lang];
...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    // Insert staff record if no errors
    if ($message === '') {
            ...
            <div class="form-container">
                ...
                <form method="POST" enctype="multipart/form-data">
                    <div class="form-group">
                        <label><?= $t['id'] ?></label>
                        <input type="text" name="id" placeholder="<?= $t['id'] ?>" required>
                    </div>
                    ...
                    <button type="submit" class="btn-submit"><?= $t['add_staff'] ?></button>
                </form>
            </div>
        </div>
