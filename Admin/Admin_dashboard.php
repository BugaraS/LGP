...
$staff_count = getCount($conn, 'staff');
$student_count = getCount($conn, 'student');
$other_count = getCount($conn, 'others');
?>
<!DOCTYPE html>
<html lang="<?= $lang ?>">
<head>
...
<div class="main-container">
    ...
    <div class="sidebar">
        ...
        <a href="Admin_staff_Registrations.php"><i class="fas fa-users"></i> <?= $t['staff'] ?></a>
        <a href="Admin_student_registrations.php"><i class="fas fa-user-graduate"></i> <?= $t['students'] ?></a>
        <a href="Admin_Guest_register.php"><i class="fas fa-briefcase"></i> <?= $t['guest'] ?></a>
    ...
    <header>
        ...
        <div class="content">
            <div class="stats">
                <div onclick="location.href='Admin_staff_Registrations.php'">
                    <i class="fas fa-users"></i>
                    <h3><?= $t['staff'] ?></h3>
                    <p><?= $staff_count ?></p>
                </div>
                <div onclick="location.href='Admin_student_registrations.php'">
                    <i class="fas fa-user-graduate"></i>
                    <h3><?= $t['students'] ?></h3>
                    <p><?= $student_count ?></p>
                </div>
                <div onclick="location.href='Admin_Others_register.php'">
