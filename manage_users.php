    ...
    <div class="main">
       ...
       <center> <h2>Manage Users</h2></center>
        <div class="content">
            ...
            <?php
            if (isset($_GET['msg'])) {
                if ($_GET['msg'] == 'deleted') echo "<p class='message success'>User deleted successfully!</p>";
                if ($_GET['msg'] == 'updated') echo "<p class='message success'>User updated successfully!</p>";
            }
            ?>
