...
<head>
<meta charset="UTF-8">
<title><?= htmlspecialchars($texts[$lang]['id_card']) ?> - DBU Laptop Exit System</title>
...
<div class="language-switcher">
    <?= htmlspecialchars($texts[$lang]['lang_label']) ?>:
    <a href="?id=<?= $id ?>&lang=en">English</a> |
    <a href="?id=<?= $id ?>&lang=am">አማርኛ</a>
</div>
...
<div class="content">
    ...
    <div class="btn-group">
        ...
        <a href="Student_registrations.php" class="btn back-btn">
