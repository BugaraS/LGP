                    ...
                    <td>
                        <div class="action-btns">
                            ...
                            <div class="action-menu">
                                <a href="User_edit_Staff.php?id=<?= $row['id'] ?>">Edit</a>
                                <a href="?delete=<?= $row['id'] ?>" onclick="return confirm('<?= $t['delete_selected'] ?>?')">Delete</a>
                                <a href="Generate_staff_LGP_id.php?id=<?= $row['id'] ?>" target="_blank">Generate Staff LGP ID</a>
                            </div>
                        </div>
                    </td>
                </tr>
