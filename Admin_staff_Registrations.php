...
if ($search > 0) {
    $total_result = $conn->query("SELECT COUNT(*) AS total FROM staff WHERE id = $search");
    $result = $conn->query("SELECT * FROM staff WHERE id = $search LIMIT $offset, $limit");
} else {
    $total_result = $conn->query("SELECT COUNT(*) AS total FROM staff");
    $result = $conn->query("SELECT * FROM staff LIMIT $offset, $limit");
}
...
<div class="main-container">
    ...
    <div class="main">
        ...
        <div class="content">
            ...
            <div class="top-bar">
                <div class="top-left">
                    <a href="Admin_staff_register.php" class="add-new"><?= $t['add_new'] ?></a>
                </div>
                ...
                <div class="top-right">
                    <form method="get" style="display:flex; gap:5px;">
                        ...
                        <a href="Admin_staff_Registrations.php" class="reset"><?= $t['reset'] ?></a>
                    </form>
                ...
                <tr>
                    ...
                    <div class="action-btns">
                            ...
                            <div class="action-menu">
                                <a href="Admin_edit_Staff.php?id=<?php echo $row['id']; ?>">Edit</a>
                                <a href="?delete=<?php echo $row['id']; ?>" onclick="return confirm('Delete this student?')">Delete</a>
                                <a href="Admin_Generate_staff_LGP_id.php?id=<?php echo $row['id']; ?>" target="_blank">Generate Student LGP ID</a>
                            </div>                  
                    </td>
                </tr>
                <?php endwhile; ?>
