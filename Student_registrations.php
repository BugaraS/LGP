...
//  language setup for english and amahric 
...
<div class="main-container">
    ...
    <div class="main">
        ...
        <div class="content">
            ...
            <div class="top-bar">
                <div class="top-left">
                    <a href="student_register.php" class="add-new"><?= $t['add_new'] ?></a>      
                </div>
                <div class="top-right">
                    <form method="get" style="display:flex; gap:5px;">
                        ...
                        <a href="Student_registrations.php" class="reset"><?= $t['reset'] ?></a>
                    </form>
                    <form method="post">
                    ...
                    <td>
                        <div class="action-btns">
                            ...
                            <div class="action-menu">
                                <a href="Student_edit_registrations.php?id=<?= $row['id'] ?>">Edit</a>
                                <a href="?delete=<?= $row['id'] ?>" onclick="return confirm('Delete this student?')">Delete</a>
                                <a href="Generate_Student_LGP_id.php?id=<?= $row['id'] ?>" target="_blank">Generate Student LGP ID</a>
                            </div>
                        </div>
                    </td>
                </tr>
        ...
        <footer>&copy; 2025 DBU. <?= $t['rights'] ?></footer>
    </div>
</div>
</body>
</html>
